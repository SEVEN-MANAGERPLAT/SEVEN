...
public class CodeGenerator {
    public static void main(String[] args) {
        // 包名+模块
        String packageName = "com.seven.aemp";
        boolean serviceNameStartWithI = false;//auth -> UserService, 设置成true: auth -> IUserService
        //把需要自动生成的表 放在这里!!
        generateByTables(serviceNameStartWithI, packageName, "dx", "mysql", "ums_admin_role_relation");
    ...
    private static void generateByTables(boolean serviceNameStartWithI, String packageName, String author, String database, String... tableNames) {
        ...
        String dbUrl = "jdbc:mysql://101.200.175.47:3306/sevenmanager";
...
//              .setSuperMapperClass("cn.saytime.mapper.BaseMapper")
    ...
    public static void main5(String[] args) {
        ...
        // 数据源配置
        DataSourceConfig dsc = new DataSourceConfig();
        dsc.setUrl("jdbc:mysql://172.16.6.78:3306/buildstore?useSSL=false&useUnicode=true&characterEncoding=utf8&allowMultiQueries=true&useTimezone=true&serverTimezone=GMT%2B8&zeroDateTimeBehavior=convertToNull");
        // dsc.setSchemaName("public");
